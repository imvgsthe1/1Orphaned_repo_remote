sap.ui.define([
		...
		"fioritest/test/integration/pages/shareOptions"
			...
			onTheWorklistPage : {
						...
						return this.waitFor(createWaitForItemAtPosition({
							...
							success : function (oTableItem) {
								...
								this.getContext().currentItem = {
									...
									id: oBindingContext.getProperty("Fname"),
									name: oBindingContext.getProperty("Education")
								};
							}
						}));
					},
				...
				assertions: jQuery.extend({
					...
					theTableShouldHaveAllEntries : function () {
						...
						// retrieve all EmpdataSet to be able to check for the total amount
						this.waitFor(this.createAWaitForAnEntitySet({
							entitySet: "EmpdataSet",
