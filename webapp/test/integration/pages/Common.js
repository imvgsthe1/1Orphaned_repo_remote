sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("fioritest/app", ".html");
		...
		return Opa5.extend("fioritest.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["fioritest/localService/mockserver"], function (mockserver) {
